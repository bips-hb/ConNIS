...
Next, we give an example how to select a weight by the instability approach. We will use the parallel version of the function using `mclapply`. We use different weights. NOTE: This might take a bit since we use 200 subsamples. You can reduce the number of subsamples.
